...
import { dimensionsType, mouseType } from "./types";

export const onMouseMove =
  (mouse: mouseType) => (e: MouseEvent | TouchEvent) => {
...
export const onScroll = (mouse: mouseType) => (e: Event) => {
  mouse.curScroll =
...
export const setupMouseEventHandlers = ({
  mouse,
  camera,
  container,
  dimensions,
